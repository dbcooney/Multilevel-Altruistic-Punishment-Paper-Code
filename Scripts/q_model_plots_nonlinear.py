...
competition following the group-level Fermi rule and fixed cost of punishment (q > 0).
This figure makes use of simulation outputs generated running the script 
...
if lamb == 2.0: 
	file1 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p5model.txt"
	file2 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p6model.txt"
	file3 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p7model.txt"
	file4 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p8model.txt"
	file5 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p86model.txt"
	file6 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p925model.txt"
elif lamb == 5.:
	file1 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p5modellamb5.txt"
	file2 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p6modellamb5.txt"
	file3 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p7modellamb5.txt"
	file4 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p8modellamb5.txt"
	file5 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p86modellamb5.txt"
	file6 = altruistic_folder + "/Simulation_Outputs/GplotDPnonlinearq0p925modellamb5.txt"
...
plt.savefig(altruistic_folder + "/Figures/avgGplotqmodelDP.png" )
...
file1 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p5modellamb5.txt"
file2 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p6modellamb5.txt"
file3 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p7modellamb5.txt"
file4 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p8modellamb5.txt"
file5 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p86modellamb5.txt"
file6 = altruistic_folder + "/Simulation_Outputs/CoopplotDPnonlinearq0p925modellamb5.txt"
...
plt.plot(p_list,avg_punisher_6_list, lw = 5., color = plt.cm.viridis((0.925 - cmap_min )/cmap_range ), label = r"$q = 0.925$")
plt.plot(p_list,avg_punisher_5_list, lw = 5., color = plt.cm.viridis((0.86 - cmap_min )/cmap_range ), label = r"$q = 0.86$")
plt.plot(p_list,avg_punisher_4_list, lw = 5., color = plt.cm.viridis((0.8 - cmap_min )/cmap_range ), label = r"$q = 0.8$")
plt.plot(p_list,avg_punisher_3_list, lw = 5., color = plt.cm.viridis((0.7 - cmap_min )/cmap_range ), label = r"$q = 0.7$")
plt.plot(p_list,avg_punisher_2_list, lw = 5., color = plt.cm.viridis((0.6 - cmap_min )/cmap_range ), label = r"$q = 0.6$")
plt.plot(p_list,avg_punisher_1_list, lw = 5., color = plt.cm.viridis((0.5 - cmap_min )/cmap_range ), label = r"$q = 0.5$")



plt.axis([0.,3.,-0.005,1.4])
plt.legend(loc = "upper left", fontsize = 14., ncol = 3)
...
if lamb == 2.:
	plt.savefig(altruistic_folder + "/Figures/avgpunisherplotqmodelDP.png")
elif lamb == 5.:
	plt.savefig(altruistic_folder + "/Figures/avgpunisherplotqmodelDPlamb5.png")
