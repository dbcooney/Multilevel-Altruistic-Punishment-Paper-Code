"""
This is the script used to run simulations for trimorphic multilevel dynamics on the 
defector-cooperator-punisher, looping through the multilevel dynamics achieved for various
strengths \lambda of between-group competition. These simulations are used to generate
the simulation data required to produce Figure 6.2 (for multilevel competition based on
the difference in the fraction of non-defection individuals) and Figure 6.4 (for
multilevel competition based on the globally normalized difference in average payoffs
between the competing groups).

This script is also used to produce the right panels in Figure B.2, which provides a 
comparison of steady-state behavior for trimorphic dynamics under a two-level replicator 
equation and under pairwise group competition based on globally normalized differences in 
average payoff.
...
and "steady" saves images at the end of long runs (40,000 timesteps) of the simulations.
"""
#quantity = "trajectory"
#quantity = "grouptime"
quantity = "none"
...
"""
Specifying the time-stepping parameters for the simulations.
"""
timesteps = 40000
...
correspond to individual-level birth-death dynamics.
"""		
...
"""
Calculating impact of individual-level competition dynamics on finite volume representation
of the densities. 
"""	
...
if kappa == 0. and group_rate_type == "average payoff":
	if kG == 0.1 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p1p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p1p0p5.txt"
		print("Hello")
	elif kG == 0.4 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p4p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p4p0p5.txt"
	elif kG == 0.1 and p == 0.7:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p1p0p7.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p1p0p7.txt"
	elif kG == 0.2 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p2p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p2p0p5.txt"
	elif kG == 0.3 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p3p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p3p0p5.txt"
	elif kG == 0.1 and p == 0.9:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p1p0p9.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p1p0p9.txt"
	elif kG == 0.1 and p == 0.3:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p1p0p3.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p1p0p3.txt"
	elif kG == 0.1 and p == 0.1:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p1p0p1.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p1p0p1.txt"
	elif kG == 0.05 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupq0p05p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupq0p05p0p5.txt"
		
elif kG == 0. and group_rate_type == "average payoff":

	if kappa == 0.1 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p5.txt"

	elif kappa == 0.4 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p5.txt"
		
	elif kappa == 0.1 and p == 0.7:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p7.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p7.txt"
		
	elif kappa == 0.1 and p == 0.9:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p9.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p9.txt"
		
	elif kappa == 0.1 and p == 0.3:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p3.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p3.txt"
		
	elif kappa == 0.1 and p == 0.1:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk0p1p0p3.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk0p1p0p3.txt"
		
	elif kappa == 2.0 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphicgroupk2p0p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphicgroupk2p0p0p5.txt"
		
	
		
		
elif kG == 0. and group_rate_type == "fraction cooperating":
	if kappa == 0.1 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p1p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p1p0p5.txt"
	elif kappa == 0.4 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p4p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p4p0p5.txt"
	elif kappa == 0.1 and p == 0.7:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p1p0p7.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p1p0p7.txt"
	elif kappa == 0.1 and p == 0.9:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p1p0p9.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p1p0p9.txt"
	elif kappa == 0.1 and p == 0.3:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p1p0p3.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p1p0p3.txt"
	elif kappa == 0.1 and p == 0.1:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationk0p1p0p1.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationk0p1p0p1.txt"
		
elif kappa == 0. and group_rate_type == "fraction cooperating":
	if kG == 0.1 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p1p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p1p0p5.txt"
	elif kG == 0.4 and p == 0.5:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p4p0p5.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p4p0p5.txt"
	elif kG == 0.1 and p == 0.3:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p1p0p3.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p1p0p3.txt"
	elif kG == 0.1 and p == 0.1:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p1p0p1.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p1p0p1.txt"
	elif kG == 0.1 and p == 0.9:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p1p0p9.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p1p0p9.txt"
	elif kG == 0.1 and p == 0.7:
		file1 = file_path + "/Simulation_Outputs/Gplottrimorphiccooperationq0p1p0p7.txt"
		file2 = file_path + "/Simulation_Outputs/Coopplottrimorphiccooperationq0p1p0p7.txt"
